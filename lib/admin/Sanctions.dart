...
class _SanctionsPageState extends State<SanctionsPage> {
  ...
  // Motifs avec montants (doivent correspondre aux valeurs acceptées par l'API)
        ...
        return Container(
          ...
          child: Column(children: [
            ...
            const Padding(padding: EdgeInsets.all(16),
                child: Text('Sanctionner un membre', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
            Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: _redDark, width: 2)),
          ),
        ),
